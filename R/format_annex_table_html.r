...
format_annex_table_html <- function(df, ecoregion, year) {
  ...
  green_icon <- '<img src="D:/GitHub_2023/icesFO/inst/symbols/green_check.png" width=30 height=30>'
  grey_icon <- '<img src="D:/GitHub_2023/icesFO/inst/symbols/grey_q.png" width=30 height=30>'
  orange_icon <- '<img src="D:/GitHub_2023/icesFO/inst/symbols/orange_oh.png" width=30 height=30>'
  red_icon <- '<img src="D:/GitHub_2023/icesFO/inst/symbols/red_cross.png" width=30 height=30>'
